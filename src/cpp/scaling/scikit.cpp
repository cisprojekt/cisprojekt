...
double scikit_mds_single(double* dissimilarities, double* x, double* x_inter, int n_samples, bool init=false, bool metric=true, int n_components=2, int max_iter=1000, bool verbose=0, double eps=1e-5, int random_state=0, bool normalized_stress = false) {
...
void scikit_mds_multi(double* dissimilarities, double* x, double* x_inter, int n_iterations, int n_samples, bool init=false, bool metric=true, int n_components=2, int max_iter=1000, bool verbose=0, double eps=1e-5, int random_state=0, bool normalized_stress = false) {
  double min_stress = 1e18;
  double stress;
  for (int i = 0; i < n_iterations; i++) {
    stress = scikit_mds_single(dissimilarities, x, x_inter, n_samples, init, metric, n_components, max_iter, verbose, eps, random_state, normalized_stress);
...
int calculateMDSscikit(void) {
  ...
  scikit_mds_multi(distmat, x, x_inter, n_iterations, n_samples, init, metric, n_components, max_iter, verbose, eps, random_state, normalized_stress);
  outputCSV(x);
