...
// // #define V_SET_SIZE4// number of close
// neighbors
// // #define S_SET_SIZE4// number of randomly
// chosen
// // neighbors
...
// int g_levels = 0;          // stores the point-counts at the associated
// levels int iteration = 0;         // total number of iterations int
// stop_iteration = 0;    // total number of iterations since changing levels
// int N = 0;                 // number of points |V|
// int n_original_dims = 2;   // original dimension h of the data (set in
// loadCSV) int n_embedding_dims = 2;  // embedding dimensions l float *g_embed
// = NULL;     // pointer to embedding coords float *g_force = NULL;     //
// pointer to embedding coords' force vectors float *g_vel = NULL;       //
// pointer to embedding coords' velocity vectors float *g_data = NULL;      //
// pointer to input data coords VECTYPE *g_vec_data = NULL;  // pointer to the
// sparse input data coordinates int g_vec_dims = 0;          // max number of
// nonzero dims in vec dataset INDEXTYPE *g_idx = NULL;     // pointer to
// INDEXTYPE coords int g_chalmers = 0;          // flag for doing chalmers
...
//         ); float *min_vals = (float *) malloc( sizeof( float ) *
//         n_original_dims ); for( int i = 0; i < n_original_dims; i++ ) {
//                 max_vals[ i ] = 0.f;
//                 min_vals[ i ] = 10000.0f;
//         }
//         k = 0;
...
// n_original_dims ) ; int shuffle_idx = 0; for( int i = 0; i <
// N*n_original_dims; i+=n_original_dims ) {
...
// /*
//         Compute Chalmers' an iteration of force directed simulation on subset
//         of
...
//       }
//       i++;
//       if (distmat[k - 1] > max_dist) {
//         max_dist = distmat[k - 1];
//       }
//     }
//   }
