...
#include "src/cpp/external/hclust/fastcluster_dm.cpp"
#include "src/cpp/external/hclust/fastcluster_R_dm.cpp"
//
...
//   1 = invalid method
//
int hclust_fast(int n, MatrixXd distmat, int method, int* merge,
                double* height) {
